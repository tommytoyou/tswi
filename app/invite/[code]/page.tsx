...
import { Satellite, Eye, EyeOff, AlertCircle, Check, Shield, Mail } from 'lucide-react';
...
export default function InvitePage() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    // Store invite code in sessionStorage so we can verify after OAuth
    sessionStorage.setItem('pendingInviteCode', code);

    // Redirect to Google OAuth - the signIn callback will handle creating the user
